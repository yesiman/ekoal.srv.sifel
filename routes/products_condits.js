...
exports.add = function (req, res) {
    ...
    req.body.condit.dateModif = shared.getReunionLocalDate();
    req.body.condit.user = new require('mongodb').ObjectID(req.decoded._id);
    req.body.condit.orga =  new require('mongodb').ObjectID(req.decoded.orga);
    db.collection('products_condits', function (err, collection) {
        if (pid == "-1")
        {
