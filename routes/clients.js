...
exports.add = function (req, res) {
    ...
    req.body.client.dateModif = shared.getReunionLocalDate();
    req.body.client.user = new require('mongodb').ObjectID(req.decoded._id);
    req.body.client.orga =  new require('mongodb').ObjectID(req.decoded.orga);
    db.collection('clients', function (err, collection) {
        if (pid == "-1")
        {
